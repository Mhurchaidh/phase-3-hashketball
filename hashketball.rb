...
def num_points_scored name
  combined_players.find {|player| player[:player_name] == name }[:points]
end

def shoe_size name
  combined_players.find {|player| player[:player_name] == name}[:shoe]
end
...
def team_names 
  # game_hash.map do |_, team_data| team_data[:team_name] end
